...
When you spot an issue, [create an issue](https://github.com/robertdebock/sysstat/issues).

Making the issue help me and others to find similar problems in the future.

### 2. Fork the project.

On the top right side of [the repository on GitHub](https://github.com/robertdebock/sysstat), click `fork`. This copies everything to your GitHub namespace.
...
```
git clone git@github.com:YOURNAMESPACE/sysstat.git
```
